/*
 * File: gravity_gun_game_bounds.js 
 * This is the gravity gun game
 */

"use strict";  // Operate in Strict mode such that variables must be declared before used!

import engine from "../../../engine/index.js";
import GravityGunGame from "./gravity_gun_game_main.js";

GravityGunGame.prototype.createBounds = function() {
    let x = 15, w = 30, y = 4;
    for (x = 15; x < 120; x+=30) 
...
GravityGunGame.prototype.wallAt = function (x, y, w) {
    let h = w * 4;
...
GravityGunGame.prototype.platformAt = function (x, y, w, rot) {
    let h = w / 8;
