...
class MyGame extends engine.Scene {
    ...
    update() {
        ...
        if(engine.input.isButtonClicked(engine.input.keys.G)){
            this.next("G");
        }

        if(engine.input.isButtonClicked(engine.input.keys.N)){
            this.next("N");
        }

        if(engine.input.isButtonClicked(engine.input.keys.S)){
            this.next("S");
        }
